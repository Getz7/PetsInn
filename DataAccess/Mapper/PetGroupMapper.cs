...
namespace DataAccess.Mapper
{
    public class PetGroupMapper
    {
        ...
        public SqlOperation RetrieveAllStatement()
        {
            ...
            operation.ProcedureName = "PR_GET_ALL_GROUPS";


            return operation;
        }
        public SqlOperation GetAsignStatement(int idCliente, int idMascota, int idGroup)
        {

            SqlOperation operation = new SqlOperation();
            operation.ProcedureName = "PR_ASIGN_GROUP";
            operation.AddIntegerParam("idMascota", idMascota);
            operation.AddIntegerParam("idCliente", idCliente);
            operation.AddIntegerParam("idGrupo", idGroup);
