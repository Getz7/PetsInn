...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        url: API_URL_BASE + "/api/Reservation/GetAdditionalServicesAvailable?idPackage=" + id,
        method: "GET",
...
$("#btn-continue").click(function (e) {
    ...
    $("input:checkbox[name=services-checked]:checked").each(function () {
        additionalServices.push(parseInt($(this).val()));
    });
    ...
    $.ajax({
        ...
        url: `${API_URL_BASE}/api/Package/AddService?id=${id}`,
        method: 'POST',
        contentType: 'application/json;charset=utf-8',
        data: JSON.stringify(additionalServices),  // Send only the array directly
